                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" value="{{ $enquiryCase->enq_no }}" type="text" name="enq_no" id="enq_no" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" value="{{ $enquiryCase->name }}" type="text" name="name" id="name" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" value="{{ $enquiryCase->cnic }}" type="text" name="cnic" id="cnic" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div>
                                    <input class="form-control" type="text" name="issue_date" id="issue_date" value="{{ $enquiryCase->issue_date }}" readonly>
                                </div>
                            </div>
                        </div>
